...
<body>
	...
	<main class="container" >
		...
		<section class="row mt-5">
			...
			<h1 class="col-md-12 d-flex justify-content-center">Nuevo Equipo</h1>			
		</div>
					<form action="?controller=team&method=save" method="POST">
						...
						<div class="form-group formulari">
							...
							<input type="text" required="" name="name" class="form-control" placeholder="Nombre del equipo" value="<?php echo isset($error['errorMessage']) ? $error['name'] : '' ?>">
						</div>
						<div class="form-group formulari">
							
							<input type="text" name="id_user" class="form-control" readonly="readonly" hidden="hidden" placeholder="Nombre del equipo" value="<?php echo $_SESSION['users']->id ?>">
						...
						<div class="form-group formulari">
							...
							<textarea type="text" required="" name="description" class="form-control" placeholder="Descripcion del equipo" value=""><?php echo isset($error['errorMessage']) ? $error['description'] : '' ?></textarea>
						...
						<div class="form-group formulari">
							<button class="btn btn-success float-right">Crear equipo</button>
						</div>
					</form>
				</div>
			</div>
